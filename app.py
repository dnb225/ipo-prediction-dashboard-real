...
# ----------------------------------------------------------------------------
    ...
    st.markdown("---")
    st.subheader("⚖️ Risk-Return Tradeoff")
...
# ----------------------------------------------------------------------------
    ...
    if predict_button:
        ...
        <em>⚠️ This is for educational purposes only. Not investment advice.</em>
        </div>
        """, unsafe_allow_html=True)
...
# ----------------------------------------------------------------------------
    ...
    # RQ1
    st.markdown("## 1️⃣ Which pre-IPO characteristics most affect first-day returns?")
    ...
    # RQ2
    st.markdown("---")
    st.markdown("## 2️⃣ Can ML classify high-risk IPOs better than baseline heuristics?")
    ...
    st.success("✅ **Answer:** YES - Machine learning models significantly outperform simple heuristics for identifying high-risk IPOs.")
    
    # RQ3
    st.markdown("---")
    st.markdown("## 3️⃣ Can ML predictions construct superior investment strategies?")
